  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <div class="mylogo me-auto">
        <img src="assets/img/sofnew.png" style="border-left: none;padding-left: 0;padding-top:5px;padding-bottom:5px;" class="apsitlogo" alt="" srcset="">
        <img src="assets/img/nhitm.webp" class="apsitlogo" alt="" srcset="">
        <img src="http://jobfair.ishraethane.co.in/assets/img/logos/job4u.png" class="apsitlogo" alt="" srcset="">
        <img src="http://jobfair.ishraethane.co.in/assets/img/logos/ishrae2.png" style="padding-top:5px;padding-bottom:5px;" class="apsitlogo" alt="" srcset="">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
                          <div class="swiper-slide"><img src="assets/img/logos2/42.jpeg" class="img-fluid" alt=""></div>
                                      <div class="swiper-slide"><img src="https://images.newindianexpress.com/uploads/user/imagelibrary/2021/8/2/w900X450/HDFC.jpg?w=400&dpr=2.6" class="img-fluid" alt=""></div>
