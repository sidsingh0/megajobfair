    ...
    <div class="sectional">
      <div class="newnavbar">
        <a href="/index.php" class="newnavbar_logos">
          ...
          <img src="./assets/img/azadi3.png" style="padding-left: 10px; border-left: 1px solid grey" alt="" srcset="" />
  </a>
        ...
        <div class="newnavbar_btns">
          ...
          <div class="mmenu">
            <a href="/index.php#heropart" style="color:black;">Home</a>
            <a href="/index.php#companiespart" style="color:black;">Company</a>
            <a href="/index.php#contact" style="color:black;">Contact Us</a>
